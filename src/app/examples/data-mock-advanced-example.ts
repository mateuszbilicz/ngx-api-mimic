...
export class DataMockAdvancedCategoryService extends NgxApiMimicMockData<
  DataMockAdvanced_Category[]
> {
  constructor() {
...
export class DataMockAdvancedProductService extends NgxApiMimicMockData<
  DataMockAdvanced_Product[]
> {
        ...
        items: {
          ...
          code: {
            ...
            customFn: (instructions) => {
              return (
                instructions.randomString(3, 3).toUpperCase() +
                '-' +
                instructions.randomNumber(1000, 9999, true, 0).toString()
              );
            },
          },
        },
  ...
  createProduct(categoryId: string, title: string, price: number) {
    const newProduct: DataMockAdvanced_Product = {
      ...
      code:
        this._$generateRandomString(3, 3).toUpperCase() +
        '-' +
        this._$generateRandomNumber(1000, 9999, true, 0).toString(),
    };

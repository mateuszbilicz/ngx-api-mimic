import { ChangeDetectionStrategy, Component, inject, model, computed, signal, effect } from '@angular/core';
...
import { Subject, switchMap, takeUntil, tap, finalize, first } from 'rxjs';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
import { Fluid } from 'primeng/fluid';

@Component({
    selector: 'app-search-dialog',
    imports: [DialogModule, ButtonModule, InputTextModule, FormsModule, Fluid],

  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title:
            '_$generatePassword(minLength: number, maxLength: number, customUpperCharset?: string, customLowerCharset?: string, customNumberCharset?: string, customSpecialCharset?: string): string',
          icon: DescriptionTreeIconMethod,

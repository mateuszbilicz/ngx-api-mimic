...
export const generateEmail = () => {
  return `${firstNames[Math.round(Math.random() * (firstNames.length - 1))]}${Math.random() > .5 ? '.' : ''}${lastNames[Math.round(Math.random() * (lastNames.length - 1))]}@test.com`.toLowerCase();
}
